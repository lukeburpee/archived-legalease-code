...
def process_partition(email_iter):
    ...
    human_model_fn = '/usr/src/app/source-files/image-detection/human_classifier.pkl'
    receipt_model_fn = '/usr/src/app/source-files/image-detection/receipt_classifier.pkl'
