...
const FolderClosedIcon = () => (
	<SvgIcon viewBox="0 0 58 58">
		<path style={{fill:'#EFCE4A', enableBackground:"new 0 0 58 58"}} d="M55.981,54.5H2.019C0.904,54.5,0,53.596,0,52.481V20.5h58v31.981C58,53.596,57.096,54.5,55.981,54.5z
		"/>
