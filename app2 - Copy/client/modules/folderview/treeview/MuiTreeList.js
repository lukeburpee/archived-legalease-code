...
import { SavedSearchIcon, FolderClosedIcon, FolderOpenIcon } from './../icons'
...
class TreeList extends Component {
    ...
    render() {
                ...
                if (listItem._shouldRender) {
                    return (
                        <ListItem
                            ...
                            innerDivStyle={{paddingLeft:'50px', paddingRight:'20px'}}
                            leftIcon={getLeftIcon(listItem, expandedListItems, i, this.props.useFolderIcons, this.props.useSearchIcons)}
        ...
        function getLeftIcon(listItem, expandedItems, i, useFolderIcons, useSearchIcons) {
            if (useFolderIcons) {
                if (listItem.children) {
                    if (expandedItems.indexOf(i) === -1) {
