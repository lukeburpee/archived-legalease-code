...
const Timer = ({label, active, time, startTimer, stopTimer}) => (
	<Paper style={{height:240, width:400, backgroundColor:grey100, marginBottom:20}}>
		...
		<IconButton style={{position:'relative', top:'auto', bottom:230, left:360, right:'auto'}}>
			<CancelIcon/>
		</IconButton>
		<IconButton style={{position:'relative', top:'auto', bottom:230, left:280, right:'auto'}}>
			<MinimizeIcon/>
		</IconButton>
		<div style={{position:'relative', bottom:250, left:180}}>
			<Subheader>Description:</Subheader>
			<TextField multiLine={true} rows={3} style={{marginLeft:20, width:180}}/>
		</div>
	</Paper>
);
