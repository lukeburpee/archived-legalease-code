...
class ViewerImpl extends Component {
	...
	componentDidMount(){
		...
		this.props.dispatch(actions.setViewerDocument(this.props.activeFile));
	...
	handleThumbnail(){
		...
		if (open){
			...
			this.props.dispatch(core.leftTroughOpen('THUMBNAILS', 300));
		}
	}
	handleHighlights(){
		let open = this.props.leftTroughOpen;
		...
		return (
			<div style={{width:'inherit', height:'inherit'}}>
				...
				<Paper style={{marginTop:'10px', display:'table', marginRight:'auto', marginLeft:'auto'}}>
					<PDF file={this.props.activeFile} rotate={this.props.rotation} scale={this.props.zoom} onDocumentComplete={this.onDocumentComplete} onPageComplete={this.onPageComplete} page={this.props.page}/>
				</Paper>
				</div>
				{pagination}
			</div>
