...
Meteor.publish('jobs.convertHtml.all', function(){
	return
});

Meteor.publish('jobs.convertPdf.all', function(){
	return
});

Meteor.publish('jobs.extractText.all', function(){
	return
});

Meteor.publish('jobs.extractMeta.all', function(){
	return
});
