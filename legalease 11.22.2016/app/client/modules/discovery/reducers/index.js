...
const discoveryDefault = {
	...
	documentPdfLinks: [
		...
		"testfiles/TestWordDoc.pdf",
		"/testfiles/TestWordDoc.doc",
		"/testfiles/ao136.pdf",
	...
	discovery: (state = discoveryDefault, action) => {
		switch(action.type){
			...
			case DISCOVERY_SET_DOCUMENT_LIST:
				return Object.assign({}, state, { documentLinks:action.documentList, totalDocumentNumber: action.documentList.length });
