...
function mapStateToProps(state) {
  return {
    error: state.fb.form.error,
    schema: state.fb.form.schema,
    uiSchema: state.fb.form.uiSchema,
    formData: state.fb.form.formData,
    dragndropStatus: state.fb.dragndrop.dragndropStatus
  };
}
