...
export default {
	documentConvertAPI: (inputType, outputType, data, callback) => {
		var options = {
	...
	documentExtractTextAPI: (data, callback) => {
		var options = {
	...
	documentExtractMetaDataAPI: (data, inputType, callback) => {
		var options = {
	...
	documentZipAPI: (data, inputType, callback) => {
		var options = {
	...
	documentUnZipAPI: (data, inputType, callback) => {
		var options = {
			url: Meteor.settings.TIKA_SERVER + '/unpack',
			headers: {
				'Content-Type': inputType
