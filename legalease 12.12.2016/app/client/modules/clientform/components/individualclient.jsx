...
class IndividualClientImpl extends Component {
	...
	handleClientCity = (event) => this.props.dispatch(actions.setClientIndividualCity(event.target.value));
	...
	render(){
		return(
			<div>
				...
				<ListItem disabled={true}>
					<TextField id="client-individual-city" underlineShow={false} onChange={this.handleClientCity} value={this.props.city} floatingLabelText="City"/>
				</ListItem>
				<ListItem disabled={true}>
					<TextField id="client-individual-state" underlineShow={false} onChange={this.handleClientState} value={this.props.state} floatingLabelText="State"/>
				</ListItem>
				<ListItem disabled={true}>
					<TextField id="client-individual-phone" underlineShow={false} onChange={this.handleClientPhone} value={this.props.phone} floatingLabelText="Phone Number"/>
				</ListItem>
				<ListItem disabled={true}>
					<TextField id="client-individual-email" underlineShow={false} onChange={this.handleClientEmail} value={this.props.email} floatingLabelText="Email"/>
				</ListItem>
				<ListItem disabled={true}>
					<TextField id="client-individual-avatar"/>
				</ListItem>
