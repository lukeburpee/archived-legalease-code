...
class ProcessingFormSectionImpl extends Component {
	...
	toggleProcessingFormSection(){
		this.props.dispatch(action.toggleProcessingFormSection());
	}
	render(){
		return(
			<Card 
				...
				onExpandChange={this.toggleProcessingFormSection}>
				<CardHeader
...
const mapStateToProps = (state) => ({
	...
	open: state.processing.processingFormPanelOpen
});
