...
class FormElementList extends Component {
	constructor(props){
		...
		this.state = {
			...
			elements: [
				...
				{label:'Radio List', data:{type:'radiolist', name:'radiolist', required:false, options:[], value:''}, icon: <RadioButtonGroup name="element_list" style={{position:'relative', bottom:5}} valueSelected="one"><RadioButton value="one"/><RadioButton value="two"/></RadioButtonGroup>},
	...
	render(){
		...
		return(
			<List style={{height:'inherit', width:'inherit'}}>
