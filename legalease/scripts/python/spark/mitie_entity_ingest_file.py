...
def extract_entities(doc_iter, extract_field='body', extracted_lang_field='body_lang', extracted_translated_field="body_translated"):
    ...
    ner_models={}
    ner_models['en'] = named_entity_extractor('/usr/src/app/MITIE-models/ner_model_english.dat')
    ner_models['es'] = named_entity_extractor('/usr/src/app/MITIE-models/ner_model_spanish.dat')
