...
export default function(){
	...
	if (DiscoveryFiles.find().count() === 0){
		DiscoveryFiles.load('http://localhost:3000/testfiles/allen-p.pst',{
			name:'allen-p.pst', 
			meta:{
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/alabama-durable-health-care-power-of-attorney-form.pdf',{
			name:'alabama-durable-health-care-power-of-attorney-form.pdf', 
			type:'application/pdf',
			meta:{
				controlId: 'M_ONE_C_ONE_0001',
				matter: 'matter1',
				collection: 'collection1',
				database: 'default',
				custodian: 'Test',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/Presentation1.pptx',{
			name:'Presentation1.pptx', 
			type:'application/vnd.openxmlformats-officedocument.presentationml.presentation',
			meta:{
				controlId: 'M_ONE_C_TWO_0001',
				matter: 'matter1',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/sample.ppt',{
			name:'sample.ppt', 
			type:'application/vnd.ms-powerpoint',
			meta:{
				controlId: 'M_ONE_C_TWO_0002',
				matter: 'matter1',
				collection: 'collection2',
				database: 'default',
				custodian: 'Test',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/sample.xlsx',{
			name:'sample.xlsx', 
			type:'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
			meta:{
				controlId: 'M_TWO_C_TWO_0001',
				matter: 'matter2',
				collection: 'collection2',
				database: 'default',
				custodian: 'Test',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/Test-case-example-doc.doc',{
			name:'Test-case-example-doc.doc', 
			type:'application/msword',
			meta:{
				controlId: 'M_TWO_C_TWO_0002',
				matter: 'matter2',
				collection: 'collection2',
				database: 'default',
				custodian: 'Test',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/Test-case-template-xls.xls',{
			name:'Test-case-template-xls.xls', 
			type:'application/vnd.ms-excel',
			meta:{
				controlId: 'M_TWO_C_TWO_0003',
				matter: 'matter2',
				collection: 'collection2',
				database: 'default',
				custodian: 'Test',
		...
		DiscoveryFiles.load('http://localhost:3000/testfiles/TestWordDoc.doc',{
			name:'TestWordDoc.doc',
			type:'application/msword',
			meta:{
				controlId: 'M_TWO_C_TWO_0004',
				matter: 'matter2',
				collection: 'collection2',
				database: 'default',
				custodian: 'Test',
